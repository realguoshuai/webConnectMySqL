...
/**
 * Servlet implementation class UpdatePasswordInfoServlet
 */
@WebServlet("/UpdatePasswordInfo.action")
public class UpdatePasswordInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePasswordInfoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("updatePasswordInfo.jsp").forward(request, response);
	}
